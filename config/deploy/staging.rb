...
set :wpcli_remote_url, -> {"http://cafetin.bits2beats.com"}
set :wpcli_local_url, -> {"http://cafetin.dev/"}

set :wpcli_local_uploads_dir, -> {"/Users/pierpaologorelli/Documents/Websites/cafetin.es/web/app/uploads/"}
